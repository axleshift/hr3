...
<html>
<head>
    <title>Payslip - {{ $payslipData['name'] }}</title>
    <style>
        body {
    ...
    <div class="payslip">
        ...
        <div class="salary-breakdown">
            ...
            <table>
                <tr>
                    <td>Monthly Rate:</td>
                    <td class="text-right">{{ number_format($payslipData['monthly_rate'], 2) }}</td>
                </tr>
                <tr>
                    <td>Half Month Salary:</td>
                    <td class="text-right">{{ number_format($payslipData['base_salary'], 2) }}</td>
                </tr>
                <tr>
                    <td>Daily Rate:</td>
                    <td class="text-right">{{ number_format($payslipData['daily_rate'], 2) }}</td>
                </tr>
                <tr>
                    <td>Hourly Rate:</td>
                    <td class="text-right">{{ number_format($payslipData['daily_rate'] / 8, 2) }}</td>
                </tr>
            </table>
        </div>
